...
| Rust Error Handling Patterns | Capability for rust-error-handling-patterns | .claude/skills/rust-error-handling-patterns/SKILL.md | When workflow requires rust-error-handling-patterns |
| Rust Ownership And Lifetimes | Capability for rust-ownership-and-lifetimes | .claude/skills/rust-ownership-and-lifetimes/SKILL.md | When workflow requires rust-ownership-and-lifetimes |
